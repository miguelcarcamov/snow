...
if __name__ == '__main__':
    ...
    imager_obj = Imager(inputvis=visfile, output=output,
                        niter=100, M=1024, N=1024, deltax="0.2arcsec", stokes="I", datacolumn="corrected", robust=0.5)
    ...
    parent_selfcal = Selfcal(visfile=clean_imager.inputvis,
                             imagename=clean_imager.output, minblperant=2, refant="VA05", spwmap=[0, 0, 0, 0], Imager=clean_imager, want_plot=want_plot)

...
if __name__ == '__main__':
    ...
    clean_imager = Clean(inputvis=visfile, output=output, niter=100, M=1024, N=1024, cell="0.3arcsec", stokes="I", datacolumn="corrected",
    ...
    parent_selfcal = Selfcal(visfile=clean_imager.getVis(), minblperant=4, refant="VA05", spwmap=[
                             0, 0, 0, 0], gaintype='G', Imager=clean_imager, want_plot=want_plot)
